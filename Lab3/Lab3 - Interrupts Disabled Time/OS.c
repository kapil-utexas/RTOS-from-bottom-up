...
uint32_t timeWithInterruptsDisabled = 0;
uint32_t startTimeOfInterruptsDisabled = 0;
uint32_t endTimeOfInterruptsDisabled = 0;
...
long OS_StartCritical(void); // Disable interrupts
void OS_EndCritical(long);  // Enable interrupts
...
unsigned long OS_MicroTime(void)
{
	return timerMsCounter; //hardcoded
}
